...
\hline
\end{DoxyParams}
\hypertarget{classMultiSet_ace92943f7461b6f683c7c4da76408e73}{\index{Multi\-Set@{Multi\-Set}!Multi\-Set@{Multi\-Set}}
\index{Multi\-Set@{Multi\-Set}!MultiSet@{Multi\-Set}}
\subsubsection[{Multi\-Set}]{\setlength{\rightskip}{0pt plus 5cm}Multi\-Set\-::\-Multi\-Set (
\begin{DoxyParamCaption}
\item[{std\-::vector$<$ {\bf Uni\-Set} $\ast$ $>$ $\ast$}]{uni\-Set\-Vector}
\end{DoxyParamCaption}
)}}\label{classMultiSet_ace92943f7461b6f683c7c4da76408e73}
...
\begin{DoxyParams}{Parameters}
{\em uni\-Set\-Vector} & \-: Vector of pointers to uni-\/dimensional sets from which the Cartesian product is computed \\
\hline
\end{DoxyParams}
...
Access to an element (i.\-e., atomic feasible subset) from its index {\bfseries in the case of a one-\/dimensional set} /param index \-: The index of the element to access /return A pointer to the unique atomic feasible subset that contains the element \hypertarget{classMultiSet_a91d471ce84161187ab63f56199c74ab3}{\index{Multi\-Set@{Multi\-Set}!get\-Atomic\-Multi\-Subset@{get\-Atomic\-Multi\-Subset}}
\index{get\-Atomic\-Multi\-Subset@{get\-Atomic\-Multi\-Subset}!MultiSet@{Multi\-Set}}
\subsubsection[{get\-Atomic\-Multi\-Subset}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Multi\-Subset} $\ast$ Multi\-Set\-::get\-Atomic\-Multi\-Subset (
\begin{DoxyParamCaption}
\item[{int $\ast$}]{indices}
\end{DoxyParamCaption}
)}}\label{classMultiSet_a91d471ce84161187ab63f56199c74ab3}
Access to an element (i.\-e., atomic feasible subset) from its indices /param indices \-: The indices of the element to access /return A pointer to the unique atomic feasible subset that contains the element \hypertarget{classMultiSet_aee151d663695e02987e8b515bd511e67}{\index{Multi\-Set@{Multi\-Set}!get\-Atomic\-Multi\-Subset@{get\-Atomic\-Multi\-Subset}}
\index{get\-Atomic\-Multi\-Subset@{get\-Atomic\-Multi\-Subset}!MultiSet@{Multi\-Set}}
\subsubsection[{get\-Atomic\-Multi\-Subset}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Multi\-Subset} $\ast$ Multi\-Set\-::get\-Atomic\-Multi\-Subset (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{values}
\end{DoxyParamCaption}
)}}\label{classMultiSet_aee151d663695e02987e8b515bd511e67}
Access to an element (i.\-e., atomic feasible subset) from an array of real values {\bfseries in the case a range has been defined for all uni-\/dimensional sets} /param values \-: An array of real values within the defined ranges /return A pointer to the unique atomic feasible subset that contains the element \hypertarget{classMultiSet_aabac7439b455032f959bb6ce9d145f7e}{\index{Multi\-Set@{Multi\-Set}!get\-Optimal\-Multi\-Subset@{get\-Optimal\-Multi\-Subset}}
\index{get\-Optimal\-Multi\-Subset@{get\-Optimal\-Multi\-Subset}!MultiSet@{Multi\-Set}}
\subsubsection[{get\-Optimal\-Multi\-Subset}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Multi\-Subset} $\ast$$\ast$ Multi\-Set\-::get\-Optimal\-Multi\-Subset (
\begin{DoxyParamCaption}
\item[{double}]{parameter, }
\item[{int}]{number}
\end{DoxyParamCaption}
)}}\label{classMultiSet_aabac7439b455032f959bb6ce9d145f7e}
Get optimal subsets ordered according to their objective values /param number \-: The number of optimal subset to return /return An array of pointers to subsets ordered according to their objective values \hypertarget{classMultiSet_a338a036d443609e814b8c8ff414cce7e}{\index{Multi\-Set@{Multi\-Set}!get\-Optimal\-Partition@{get\-Optimal\-Partition}}
...
Access to a random element (i.\-e., atomic feasible subset) /return A pointer to the unique atomic feasible subset that contains the element \hypertarget{classMultiSet_a5f8567d28993d4e5c6c314cc5dbca188}{\index{Multi\-Set@{Multi\-Set}!print\-Optimal\-Partition@{print\-Optimal\-Partition}}
